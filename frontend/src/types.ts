...
export type Entity = { id: string; name: string; slug: string; description?: string | null; active: boolean; created_at: string; updated_at: string; owner_id?: string; owner?: Owner; default_blocking_severities?: string[] }
