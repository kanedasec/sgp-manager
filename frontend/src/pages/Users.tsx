import { Edit3, LogOut, Plus, Power, UserRound } from 'lucide-react'
...
export default function Users() {
  ...
  const revokeSessions = async (item: AdminUser) => {
    setError('')
    try { await api(`/api/v1/admin/users/${item.id}/revoke-sessions`, { method: 'POST' }) }
    catch (e) { setError(e instanceof Error ? e.message : 'Could not revoke sessions') }
  }
